...
class BackendViewDrawItemHook implements PageLayoutViewDrawItemHookInterface
{
    ...
    public function preProcess(PageLayoutView &$parentObject, &$drawItem, &$headerContent, &$itemContent, array &$row)
    {
         ...
         */
        if (!('list' === $row['CType'] && 'tgmreveal_reveal' === $row['list_type'])) {
            return;
        }
         ...
         */
        $fluidTmplFilePath = GeneralUtility::getFileAbsFileName('typo3conf/ext/tgm_reveal/Resources/Private/Templates/BackendTemplate.html');
